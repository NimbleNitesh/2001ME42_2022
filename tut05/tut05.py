...
def octant_range_names(mod=5000):
    ...
    try:
        #using lamda function to set precision
    ...
    try:
        ...
        print('Error in calculating Octants and their frequency')
        exit()
    df[' '][1]="User Input"
    ...
    try:
        ...
        print('Error in execution of customsort function')
    #print(thisdict)
    try:
        ...
        print('Error in finding the Octant(s) with rank 1')
        exit()
    ...
    try:
        #Creating a list which will store the interval in which mod will divide entire data
        l=[]
        cur=0
        ...
        print('Error in creating the list containing mod partition intervals')
        exit()
    n=len(l)
    cur_pos=2
    ...
    try:
        #Performing the same above two operations[Counting Octant Frequency and Finding Octant Rank] but in range according to mod
        for i in range(n):
            low=l[i]
            high=l[i]+x
            if high>row_cnt:
        ...
        print('Error in calculation occuring in Mod Ranges')
        exit()
    ...
    try:
        ...
        print('Error in editing Count of Rank 1 Mod Values in the dataframe')
        exit()
    try:
        #Exporting Data
