...
try:
	...
	print('Error in set_border function')
	exit()
try:            
	...
	print('Error in set_highlight function')
	exit()
...
try:
	...
	print('Error in OctantCount function')
	exit()
...
try:
	...
	print('Error in GiveRank function')
	exit()
...
try:
	...
	print('Error in TransitionCount function')
	exit()

#Help
def octant_analysis(mod, src):
	# print(type(mod))
	st_border_=[]
	mod=int(mod)
	try:
		...
		print('Errorrrr in Reading file from input folder')
		exit()
	for file in filenames:
		...
		try:
			...
			print('Error in setting decimal precision')
			exit()
		...
		try:
			...
			print('Error in Overall Octant Count and Rank dataframe')
			exit()
		...
		try:
			...
			print('Error in setting transition dataframe')
		...
		try:
			...
			print('Error in Longest Subsequence Length dataframe')
			exit()
		...
		try:
			...
			print('Error in Longest Subsquence Length with Range dataframe')
			exit()
		...
		try:
			...
			print('Error in exporting xlsx files')
			print(stringg)
			exit()
		...
		try:
			...
			st_border_size=len(st_border_)
			for i in range(st_border_size):
				lx1=st_border_[i][0][0]
				ly1=st_border_[i][0][1]
				lx2=st_border_[i][1][0]
				ly2=st_border_[i][1][1]
				lx1+=2
				lx2+=1
				qq=ly1+str(lx1)+':'+ly2+str(lx2)
				# print(qq)
				set_border(qq, worksheet)
	...
	## output filename = input_filename[_octant_analysis_mod_5000].xlsx , ie, append _octant_analysis_mod_5000 to the original filename. 
			...
			print('Error in using openpyxl library')
			exit()
###Code
def main(mod, src): 
